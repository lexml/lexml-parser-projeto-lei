...
import br.gov.lexml.parser.pl.misc.CollectionUtils.collapseBy
import br.gov.lexml.parser.pl.misc.CollectionUtils.collapseBy3
import br.gov.lexml.parser.pl.misc.XMLStreamUtils.collectPars

...
trait DefaultRegexProfile extends RegexProfile:
  ...
  override def regexJustificativa: List[Regex] =
    super.regexJustificativa ++ List(
      "^justificacao".r,
  ...
  override def regexLegislacaoCitada: List[Regex] =
    super.regexLegislacaoCitada ++ List(
      "^legislacao citada".r,
      "^l e g i s l a c a o c i t a d a".r
    )
  override def regexAssinatura: List[Regex] =
    super.regexAssinatura ++ List("^senadora? " r)
...
trait TipoNormaProfile:
  ...
  def epigrafeTemplateCode: String =
    """<epigrafeHead> <epigrafeRepr> <epigrafeTail>"""
  def epigrafeSemIdTemplateCode: String =
    """<epigrafeHead> Nº LEXML_EPIGRAFE_NUMERO de LEXML_EPIGRAFE_DATA <epigrafeTail>"""
...
trait LocalidadeBR extends LocalidadeProfile:
  override def urnFragLocalidade : Option[String] = Some("br")

trait DocumentProfile
    extends RegexProfile
    with TipoNormaProfile
    with AutoridadeProfile
    with LocalidadeProfile:
  ...
  private def asMap: Map[String, Any] = Map(
...
final case class DocumentProfileOverride(
  ...
  override def regexLocalData: List[Regex] =
    overrideRegexLocalData.getOrElse(base.regexLocalData)
  override def regexJustificativa: List[Regex] =
    overrideRegexJustificativa.getOrElse(base.regexJustificativa)
  override def regexAnexos: List[Regex] =
    overrideRegexAnexos.getOrElse(base.regexAnexos)
  override def regexLegislacaoCitada: List[Regex] =
    overrideRegexLegislacaoCitada.getOrElse(base.regexLegislacaoCitada)
  override def regexAssinatura: List[Regex] =
    overrideRegexAssinatura.getOrElse(base.regexAssinatura)
  override def regexEpigrafe1: List[Regex] =
    overrideRegexEpigrafe1.getOrElse(base.regexEpigrafe1)
  override def regexEpigrafe: List[Regex] =
    overrideRegexEpigrafe.getOrElse(base.regexEpigrafe)
  override def regexPosEpigrafe: List[Regex] =
    overrideRegexPosEpigrafe.getOrElse(base.regexPosEpigrafe)
  override def epigrafeObrigatoria: Boolean =
    overrideEpigrafeObrigatoria.getOrElse(base.epigrafeObrigatoria)
  override def preEpigrafePermitida: Boolean =
    overridePreEpigrafePermitida.getOrElse(base.preEpigrafePermitida)
  override def regexPreambulo: List[Regex] =
    overrideRegexPreambulo.getOrElse(base.regexPreambulo)
  override def urnFragTipoNorma: String =
    overrideUrnFragTipoNorma.getOrElse(base.urnFragTipoNorma)
  override def epigrafeHead: String =
    overrideEpigrafeHead.getOrElse(base.epigrafeHead)
  override def epigrafeTail: String =
    overrideEpigrafeTail.getOrElse(base.epigrafeTail)
  override def urnFragAutoridade: String =
    overrideUrnFragAutoridade.getOrElse(base.urnFragAutoridade)
  override def autoridadeEpigrafe: Option[String] =
    overrideAutoridadeEpigrafe.getOrElse(base.autoridadeEpigrafe)
  override def urnFragLocalidade: Option[String] =
    overrideUrnFragLocalidade.getOrElse(base.urnFragLocalidade)
  override def ementaAusente: Boolean =
    overrideEmentaAusente.getOrElse(base.ementaAusente)

  val hasOverride: Boolean = this.productIterator.exists {
    _.isInstanceOf[Some[_]]
  }

  @targetName("plus")
  override def +(o: Overrides): DocumentProfileOverride = copy(
    overrideRegexLocalData =
      o.overrideRegexLocalData orElse overrideRegexLocalData,
    overrideRegexJustificativa =
      o.overrideRegexJustificativa orElse overrideRegexJustificativa,
    overrideRegexAnexos = o.overrideRegexAnexos orElse overrideRegexAnexos,
    overrideRegexLegislacaoCitada =
      o.overrideRegexLegislacaoCitada orElse overrideRegexLegislacaoCitada,
    overrideRegexAssinatura =
      o.overrideRegexAssinatura orElse overrideRegexAssinatura,
    overrideRegexEpigrafe1 =
      o.overrideRegexEpigrafe orElse overrideRegexEpigrafe1,
    overrideRegexEpigrafe =
      o.overrideRegexEpigrafe orElse overrideRegexEpigrafe,
    overrideRegexPosEpigrafe =
      o.overrideRegexPosEpigrafe orElse overrideRegexPosEpigrafe,
    overrideEpigrafeObrigatoria =
      o.overrideEpigrafeObrigatoria orElse overrideEpigrafeObrigatoria,
    overridePreEpigrafePermitida =
      o.overridePreEpigrafePermitida orElse overridePreEpigrafePermitida,
    overrideRegexPreambulo =
      o.overrideRegexPreambulo orElse overrideRegexPreambulo,
    overrideUrnFragTipoNorma =
      o.overrideUrnFragTipoNorma orElse overrideUrnFragTipoNorma,
    ...
    overrideUrnFragAutoridade =
      o.overrideUrnFragAutoridade orElse overrideUrnFragAutoridade,
    overrideAutoridadeEpigrafe =
      o.overrideAutoridadeEpigrafe orElse overrideAutoridadeEpigrafe,
    overrideUrnFragLocalidade =
      o.overrideUrnFragLocalidade orElse overrideUrnFragLocalidade,
    overrideEmentaAusente =
      o.overrideEmentaAusente orElse overrideEmentaAusente
  )
...
object DocumentProfileOverride:
  ...
  def fromJSON(json: String): DocumentProfileOverride =
...
trait ConstituicaoFederalProfile
    extends ConstituicaoProfile
    with FederalProfile
    with EmentaAusente:
...
trait AtoDisposicoesConstitucionaisTransitoriasProfile
    extends TipoNormaProfile
    with FederalProfile
    with EmentaAusente:
  ...
  override def epigrafeTail = ""
  override def epigrafeTemplateCode : String = epigrafeHead
  override def epigrafeSemIdTemplateCode : String = epigrafeHead
...
trait ResolucaoProfile extends NormaProfile:
  ...
  override def regexEpigrafe: List[Regex] =
    super.regexEpigrafe ++ List("^resolucao".r)
  override def regexEpigrafe1: List[Regex] =
    super.regexEpigrafe1 ++ List("^resolucao".r)
...
trait DecretoLegislativoProfile extends NormaProfile:
  ...
  override def regexEpigrafe: List[Regex] =
    super.regexEpigrafe ++ List("^decreto".r)
  override def regexEpigrafe1: List[Regex] =
    super.regexEpigrafe1 ++ List("^decreto".r)
...
object Lei extends NormaFederalProfile:
  ...
  override def regexEpigrafe: List[Regex] =
    super.regexEpigrafe ++ List("^lei".r)
  override def regexEpigrafe1: List[Regex] =
    super.regexEpigrafe1 ++ List("^lei".r)
...
object LeiComplementar extends NormaFederalProfile:
  ...
  override def regexEpigrafe: List[Regex] =
    super.regexEpigrafe ++ List("^lei complementar".r)
  override def regexEpigrafe1: List[Regex] =
    super.regexEpigrafe1 ++ List("^lei complementar".r)
...
object LeiDelegada extends NormaFederalProfile:
  ...
  override def regexEpigrafe: List[Regex] =
    super.regexEpigrafe ++ List("^lei delegada".r)
  override def regexEpigrafe1: List[Regex] =
    super.regexEpigrafe1 ++ List("^lei delegada".r)
...
object DecretoLei extends NormaFederalProfile:
  ...
  override def regexEpigrafe: List[Regex] =
    super.regexEpigrafe ++ List("^decreto-lei".r)
  override def regexEpigrafe1: List[Regex] =
    super.regexEpigrafe1 ++ List("^decreto-lei".r)
...
object Decreto extends NormaFederalProfile:
  ...
  override def regexEpigrafe1: List[Regex] =
    super.regexEpigrafe1 ++ List("^decreto".r)
  override def epigrafeTemplateCode: String =
    """DECRETO Nº <numeroComComplemento>, DE <dataExtenso>"""
  // FIXME: Decreto não numerado

object DecretoLegislativoFederal
    extends DecretoLegislativoProfile
    with FederalProfile:
  override def epigrafeTemplateCode: String =
    """DECRETO LEGISLATIVO Nº <numeroComComplemento>, DE <ano>"""

object DecretoLegislativoDoCongresso
    extends DecretoLegislativoProfile
    with DoCongressoProfile:
  override def epigrafeTemplateCode: String =
    """DECRETO LEGISLATIVO Nº <numeroComComplemento>, DE <ano>-CN"""

object EmendaConstitucional
    extends DocumentProfile
    with DefaultRegexProfile
    with FederalProfile:
  override def urnFragTipoNorma = "emenda.constitucional"
  override def epigrafeHead = "EMENDA CONSTITUCIONAL"
  override def regexEpigrafe1: List[Regex] =
    super.regexEpigrafe1 ++ List("^emenda constitucional" r)
  override def regexEpigrafe: List[Regex] =
    super.regexEpigrafe ++ List("^emenda constitucional" r)
  override def epigrafeTemplateCode: String =
    """EMENDA CONSTITUCIONAL Nº <numeroComComplemento>"""

object EmendaConstitucionalDeRevisao
    extends DocumentProfile
    with DefaultRegexProfile
    with FederalProfile:
  ...
  override def regexEpigrafe1: List[Regex] =
    super.regexEpigrafe1 ++ List("^emenda constitucional de revis" r)
  override def regexEpigrafe: List[Regex] =
    super.regexEpigrafe ++ List("^emenda constitucional de revis" r)
  override def epigrafeTemplateCode: String =
    """EMENDA CONSTITUCIONAL DE REVISÃO Nº <numeroComComplemento>"""
  override def ementaAusente = true
...
object ResolucaoDoCongresso extends ResolucaoProfile with DoCongressoProfile:
  override def epigrafeTemplateCode: String =
    """RESOLUÇÃO Nº <numeroComComplemento>, DE <ano>-CN"""

object ResolucaoDoSenado extends ResolucaoProfile with DoSenadoProfile:
  override def epigrafeTemplateCode: String =
    """RESOLUÇÃO Nº <numeroComComplemento>, DE <ano>"""

object RegimentoInternoSenado
    extends RegimentoInternoProfile
    with DoSenadoProfile:
  override def epigrafeTemplateCode: String =
    """REGIMENTO INTERNO DO SENADO FEDERAL"""
  override def epigrafeSemIdTemplateCode: String =
    """REGIMENTO INTERNO DO SENADO FEDERAL"""

object RegimentoInternoCamara
    extends RegimentoInternoProfile
    with DaCamaraProfile:
  override def epigrafeTemplateCode: String =
    """REGIMENTO INTERNO DA CÂMARA DOS DEPUTADOS"""
  override def epigrafeSemIdTemplateCode: String =
    """REGIMENTO INTERNO DA CÂMARA DOS DEPUTADOS"""

object RegimentoComumCongresso
    extends RegimentoInternoProfile
    with DoCongressoProfile:
  override def epigrafeTemplateCode: String =
...
object ProjetoDeLeiDoSenadoNoSenado
    extends DocumentProfile
    with DefaultRegexProfile
    with DoSenadoProfile
    with ProjetoNorma:
...
object ProjetoDeLeiDaCamaraNoSenado
    extends DocumentProfile
    with DefaultRegexProfile
    with DoSenadoProfile
    with EpigrafeOpcional
    with ProjetoNorma:
...
object ProjetoDeLeiDoCongressoNacional
    extends DocumentProfile
    with DefaultRegexProfile
    with DoCongressoProfile
    with EpigrafeOpcional
...
object PropostaEmendaConstitucionalNoSenado
    extends DocumentProfile
    with DefaultRegexProfile
    with DoSenadoProfile
    with ProjetoNorma:
...
object ProjetoDeResolucaoDoSenado
    extends DocumentProfile
    with DefaultRegexProfile
    with DoSenadoProfile
    with ProjetoNorma:
...
object ProjetoDeDecretoLegislativoDoSenadoNoSenado
    extends DocumentProfile
    with DefaultRegexProfile
    with DoSenadoProfile
    with PreEpigrafeProibida
    with EpigrafeOpcional
    with ProjetoNorma:
  override def urnFragTipoNorma = "projeto.decreto.legislativo;pds"
  override def epigrafeHead = "PROJETO DE DECRETO LEGISLATIVO (SF)"

object ProjetoDeDecretoLegislativoDaCamaraNoSenado
    extends DocumentProfile
    with DefaultRegexProfile
    with DoSenadoProfile
    with EpigrafeOpcional
...
object ProjetoDeDecretoLegislativoDaCamaraNovaNomenclatura
    extends DocumentProfile
    with DefaultRegexProfile
    with DaCamaraProfile
    with EpigrafeOpcional
...
object ProjetoDeDecretoLegislativoDoSenadoNovaNomenclatura
    extends DocumentProfile
    with DefaultRegexProfile
    with DoSenadoProfile
    with EpigrafeOpcional
...
object ProjetoDeLeiComplementarDoSenadoNoSenado
    extends DocumentProfile
    with DefaultRegexProfile
    with DoSenadoProfile
    with ProjetoNorma:
...
object ProjetoDeLeiComplementarDaCamaraNoSenado
    extends DocumentProfile
    with DefaultRegexProfile
    with DoSenadoProfile
    with EpigrafeOpcional
...
object ProjetoDeLeiNovaNomenclatura
    extends DocumentProfile
    with DefaultRegexProfile
    with DoSenadoProfile
    with EpigrafeOpcional
...
object ProjetoDeLeiComplementarNovaNomenclatura
    extends DocumentProfile
    with DefaultRegexProfile
    with DoSenadoProfile
    with EpigrafeOpcional
...
object ProjetoDeLeiComplementarNaCamara
    extends DocumentProfile
    with DefaultRegexProfile
    with DaCamaraProfile
    with EpigrafeOpcional
...
object ProjetoDeResolucaoNaCamara
    extends DocumentProfile
    with DefaultRegexProfile
    with DaCamaraProfile
    with EpigrafeOpcional
...
object MedidaProvisoriaNoCongresso
    extends DocumentProfile
    with DefaultRegexProfile
    with DoCongressoProfile
    with ProjetoNorma:
  ...
  override def regexEpigrafe: List[Regex] =
    super.regexEpigrafe ++ List("^medida provisoria".r)
  override def regexEpigrafe1: List[Regex] =
    super.regexEpigrafe1 ++ List("^medida provisoria".r)

object MedidaProvisoriaFederal
    extends DocumentProfile
    with DefaultRegexProfile
    with FederalProfile:
...
object ConstituicaoFederal
    extends DocumentProfile
    with ConstituicaoFederalProfile
    with DefaultRegexProfile:
  override def regexLocalData: List[Regex] = super.regexLocalData ++ List(
    "^sala da sessao".r,
    "^sala das sessoes".r,
  ...
  override def epigrafeTemplateCode: String =
    """Constituição da República Federativa do Brasil."""
end ConstituicaoFederal

object AtoDisposicoesConstitucionaisTransitorias
    extends DocumentProfile
    with AtoDisposicoesConstitucionaisTransitoriasProfile
    with DefaultRegexProfile:
  override def regexLocalData: List[Regex] =
  ...
  override def regexPreambulo: List[Regex] = List()
  override def regexEpigrafe1: List[Regex] = List(
    """^ato das disposicoes constitucionais""".r
  )
  override def regexEpigrafe: List[Regex] = List(
    """^ato das disposicoes constitucionais""".r
  )

object ProjetoDeLeiDeConversao
    extends DocumentProfile
    with DefaultRegexProfile
    with DoCongressoProfile
    with ProjetoNorma:
  ...
  override def regexEpigrafe: List[Regex] =
    super.regexEpigrafe ++ List("^projeto de lei de convers".r)
  override def regexEpigrafe1: List[Regex] =
    super.regexEpigrafe1 ++ List("^projeto de lei de convers".r)

  override def epigrafeObrigatoria: Boolean = false

object DocumentProfileRegister:
  private type Autoridade = String
  private type TipoNorma = String
  private type Localidade = Option[String]
  var profiles: Map[(Localidade, Autoridade, TipoNorma), DocumentProfile] =
    Map()
  private def register(profile: DocumentProfile): Unit =
    profiles = profiles + ((
      profile.urnFragLocalidade,
      profile.urnFragAutoridade,
      profile.urnFragTipoNorma
    ) -> profile)

  def getProfile(
                  autoridade: Autoridade,
                  tipoNorma: TipoNorma,
                  localidade: Option[String] = Some("br")
                ): Option[DocumentProfile] = profiles.get((localidade, autoridade, tipoNorma))
  def profileByAutoridadeSigla(
                                autoridade: Autoridade,
                                sigla: String
                              ): Option[DocumentProfile] =
    profiles
      .view.filterKeys({ case (_, aut, tn) =>
        aut == autoridade && tn.endsWith(";" + sigla)
      })
      .values
      .headOption
  def autoridades: Set[Autoridade] = profiles.keySet.map(_._2)
  def tiposDeNormasPorAutoridade(autoridade: String): Set[String] = for {
    (_, aut, tn) <- profiles.keySet; if aut == autoridade
  } yield tn
  def tiposDeNormas: Set[String] = profiles.keySet.map(_._2)
  def byUrnFrag(urnFrag: String): Option[DocumentProfile] =
    urnFrag.split(":").toList match {
      case autoridade :: tipoNorma :: _ => getProfile(autoridade, tipoNorma)
      case _                            => None
    }

  def dumpProfiles(
                    pw: java.io.PrintWriter = new java.io.PrintWriter(System.err)
                  ) : Unit =
    profiles.to(Vector).sortBy { case (x, y) => x }.foreach {
      case ((loc, aut, tn), prof) =>
        System.err
          .println(s"localidade: $loc, autoridade=$aut, tipoNorma: $tn")
        System.err.println(prof)
        System.err.println()
    }


  private val builtins: List[DocumentProfile] = List[DocumentProfile](

...
case class Metadado(profile : BasicProfile, id : Option[Id] = None, hashFonte : Option[Array[Byte]]) {	
	...
	def toXMLmetadadoEditor(pl : ProjetoLei) : NodeSeq = ( 
		...
		<VersaoParser>2.0.0</VersaoParser>
...
trait BasicProfile extends TipoNormaProfile with AutoridadeProfile {
